(function () {
  ...
  function htmlCard(repo, showOwner, data) {
    ...
    return (
      ...
      parts[1] +
      "</span></div>" +
      '<p class="gpc-description">' +
      ((data && data.description) || "") +
      "</p>" +
      '<div class="gpc-footer">' +
      (data && data.language
        ? '<span class="gpc-lang"><span class="gpc-lang-dot" style="background:' +
          (LANG_COLORS[data.language] || "#8b949e") +
          '"></span>' +
          data.language +
          "</span>"
        : "") +
      ...
      fetch("https://api.github.com/repos/" + repo)
        ...
        .then(function (data) {
          ...
          probe.onload = function () {
            ...
            anchor.innerHTML =
              '<img class="only-light w-100" alt="' +
              repo +
              '" src="' +
              statsBase +
              "/api/pin/?username=" +
