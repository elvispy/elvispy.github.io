...
My work uses mathematics and computation to study nonlinear fluids and soft materials. I focus on problems where flow, deformation, and contact are coupled tightly enough that simplifying one changes the prediction. Current projects include [interfacial locomotion]({{ '/projects/3_surferbot/' | relative_url }}), non-Hertzian impact, and multiphase mixing in bioreactors for [alternative protein manufacturing]({{ '/projects/0_bioreactor/' | relative_url }}). These efforts combine high-fidelity simulation with reduced-order reasoning to bridge first-principles physics and emerging data-driven methods.
