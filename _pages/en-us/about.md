...
I develop mathematical and computational methods for nonlinear fluids, soft materials, and scientific design. I focus on problems where flow, deformation, and contact evolve together: a droplet changes the surface it hits, and that changed surface determines the next stage of the impact. Current projects span [interfacial locomotion]({{ '/projects/3_surferbot/' | relative_url }}), deformable impact, and multiphase bioreactors for [alternative protein manufacturing]({{ '/projects/0_bioreactor/' | relative_url }}). I also build agentic workflows for data-driven design. In [a3dasm]({{ '/projects/8_agentic/' | relative_url }}), specialised agents use simulation results to propose, test, and refine designs.
