...
- Trate el laboratorio como un sistema de datos: _también construimos un monitor IoT de bajo costo_ (ESP8266 + sensor de flujo Hall) para proteger el tiempo de actividad de FMR con alertas de correo electrónico automatizadas. :contentReference[oaicite:11]{index=11}
